...
#pragma region menu
		cout << u8"\t\t\tQuesto è il menu della pasticceria\n\n\n";
		...
		int totric = 10;
		cout << u8"digita 0 per terminare la selezione, il massimo dei dolci ordinabili è 10; digita c per chiudere la console\n\n ";
